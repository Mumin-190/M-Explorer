...
import me.mumin.android.files.compat.getDrawableCompat
import me.mumin.android.files.compat.isSingleLineCompat
import me.mumin.android.files.databinding.FileItemGridBinding
import me.mumin.android.files.databinding.FileItemListBinding
...
import me.mumin.android.files.ui.AnimatedListAdapter
import me.mumin.android.files.ui.CheckableForegroundLinearLayout
import me.mumin.android.files.ui.CheckableItemBackground
import me.mumin.android.files.util.getColorStateListByAttr
import me.mumin.android.files.util.isMaterial3Theme
...
class FileListAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int, payloads: List<Any>) {
        ...
        holder.iconImage.apply {
            ...
            imageTintList = if (isDirectory) primaryColorStateList else null
        }
