...
import me.mumin.android.files.provider.remote.IRemoteFileService
import me.mumin.android.files.provider.remote.RemoteFileServiceInterface
import me.mumin.android.files.provider.remote.RemoteFileSystemException
...
object SuiFileServiceLauncher {
    ...
    fun isSuiAvailable(): Boolean {
        synchronized(lock) {
            ...
            return Sui.isSui() || Shizuku.pingBinder()
        }
    }
