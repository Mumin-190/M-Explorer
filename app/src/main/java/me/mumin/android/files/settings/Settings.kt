...
import me.mumin.android.files.compat.EnvironmentCompat2
import me.mumin.android.files.filelist.FileSortOptions
import me.mumin.android.files.filelist.FileViewType
import me.mumin.android.files.filelist.OpenApkDefaultAction
...
object Settings {
    ...
    val SFTP_SERVER_PORT: SettingLiveData<Int> =
        IntegerSettingLiveData(
            R.string.pref_key_sftp_server_port, R.integer.pref_default_value_sftp_server_port
        )
    ...
    val MATERIAL3_THEME_STYLE: SettingLiveData<ThemeStyle> =
        EnumSettingLiveData(
            R.string.pref_key_material3_theme_style,
            R.string.pref_default_value_material3_theme_style,
