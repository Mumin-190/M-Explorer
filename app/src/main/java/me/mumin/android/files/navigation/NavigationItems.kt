...
import me.mumin.android.files.compat.isPrimaryCompat
import me.mumin.android.files.compat.pathCompat
...
import me.mumin.android.files.sftpserver.SftpServerActivity
import me.mumin.android.files.settings.Settings
import me.mumin.android.files.settings.SettingsActivity
import me.mumin.android.files.settings.StandardDirectoryListActivity
...
import me.mumin.android.files.util.isMounted
...
private val menuItems: List<NavigationItem>
    ...
    get() = listOf(
        ...
        IntentMenuItem(
            R.drawable.shared_directory_icon_white_24dp, R.string.navigation_sftp_server,
            SftpServerActivity::class.createIntent()
        ),
        IntentMenuItem(
